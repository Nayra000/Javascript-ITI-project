...
document.getElementById("bookName").addEventListener("change", bookNameValidate);
document.getElementById("price").addEventListener("change", bookPriceValidate);
document.getElementById("authorName").addEventListener("change", authorNameValidate);
document.getElementById("authorEmail").addEventListener("change", authorEmailValidate);
